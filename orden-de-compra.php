...
<body>
                ...
                <div class="col-lg-12">
                    <div class="orden">
                        <div class="orden-compra">
                            <div class="orden-ticket">
                                <h3>ORDEN DE COMPRA</h3>
                                <div class="usuario">
                                <?php $query="Select * from usuario where id=".$_USER;
                            $resultado=mysqli_query($conexion,$query);
                            $nombre_user = mysqli_fetch_array($resultado)?>
                                    <input type="text" name="usuario" placeholder="Nombre de Usuario" value="<?php echo $nombre_user['nombre']." ".$nombre_user['apellido']?>" disabled>
                                </div>
                                <div class="direccion row">
                                    <input type="text" name="direccion" disabled placeholder="Direccion" value="<?php echo $nombre_user['Direccion'];?>">
                                ...
                                <div class="boton-orden">
                                    <button id="" type="submit" class="btn btn-dark">ACEPTAR</button>
                                </div>
                                <br>
                            </div>
                        </div>
    ...
    <!-- Fin Contenido Carrito de Compras -->
