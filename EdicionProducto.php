                    ...
                    <article>
                            <ol class="lista">
                              ...
                              <?php $resultado=mysqli_query($conexion,$sql);
                                ...
                                <input value="<?php echo $row['nombre'];?>" class="ob" id="Nombre" type="text" placeholder="Nombre" maxlength="15" name="cod" required title="Este campo es Obligatorio."></p>
                              </li>
                              <li>
                                <p   for="codigo">Código del Producto: 
                                <input readonly value="<?php echo $row['codigo'];?>" class="ob" id="codigo" type="text" placeholder="Código" maxlength="15" name="cod" required title="Este campo es Obligatorio."></p>
                              </li>
                              <li>
                                <p  >Categoria: </p>
                                    <select id="categoria" type="Select" class="Select" name="cat" required title="Este campo es Obligatorio.">
                                        <option value="Cortes" 
                                        <?php if(in_array('Cortes',$row)):?> selected="selected" <?php endif;?>>Cortes</option>
                                        <option value="Sazonadores" 
                                        <?php if(in_array('Sazonadores',$row)):?> selected="selected" <?php endif;?>>Sazonadores</option>
                                        <option value="Utencilios" 
                                        <?php if(in_array('Utencilios',$row)):?> selected="selected" <?php endif;?>>Utencilios</option>
                                      </select>                                    
                              </li>
                              <br>
                              <li>
                                <p for="cantidad">Cantidad en Stock: 
                                <input class="ob" id="cantidad" type="number" value="<?php echo $row['Cantidad'];?>" name="cant" required title="Este campo es Obligatorio."></p>
                              </li>
                              <li>
                                <p   for="precio">Precio: $
                                <input class="ob" id="precio" type="text" maxlength="10" name="price" value="<?php echo $row['Precio'];?>" required title="Este campo es Obligatorio."></p>
                              </li>
                              <?php                                    
                                }?>
                            </ol>
                            <br>
                            <button type="button" id="act2" class="site-btn">Actualizar</button>
                      </article>
                </div>
            </div>
        </div>
